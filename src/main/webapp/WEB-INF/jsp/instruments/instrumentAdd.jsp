	...
	<body onload="setLanguage('${language}', '${msg_search}', 'instruments');">
		...
		<div ng-app="myApp" class="container-fluid">
		    <div class="container xd-container">
		        <h2><fmt:message key="instrumentAdd"/></h2>
		
				<div ng-controller="instrumentController">
				    <div id="instrument" data-ng-init="getNew()">
				    	<table>
				        	<tr>
				        		<th style="width: 100px;"><fmt:message key="tbName"/>:</th>
				        		<td class="field_data"><input id="name" name="name" type="text" ng-model="instrument.name" required/></td>
				        	</tr>
				        </table>
		                ...
		                <div id="footer" class="footer">
							<button type="submit" form="" value="Checkout" ng-click="add(); $event.stopPropagation();" class="btn_bottom"><fmt:message key="checkout"/></button>
		               	</div>
				    </div>
		        </div>
